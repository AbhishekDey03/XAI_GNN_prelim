...
print(f'Number of edges (incl. self-loops): {num_edges}')
...
ax.set_title('t-SNE of GCN Latent Node Embeddings, KNN adjacency', size=16)
ax.set_xlabel('t-SNE Dimension 1')
ax.set_ylabel('t-SNE Dimension 2')
plt.savefig('tSNE_gcn_latent_embeddings_knn_adjacency.png')
plt.show()
...
plot_silhouette(X, labels, 'Silhouette — Original Input Features',save = True, plot_name='silhouette_original_features.png')
plot_silhouette(H, labels, 'Silhouette — GCN Final Layer, KNN Adjacency', save=True, plot_name='silhouette_gcn_final_layer_knn.png')
